...
export default function CreatorProfilePage({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-20 md:py-28 space-y-14 md:space-y-16">
      {/* HERO */}
      <section className="relative">

        {/* COVER (world) — shorter + discreet on mobile */}
        ...
        {/* AVATAR — overlaps world by ~50% (mobile-first), “touching” left edge */}
        <div className="absolute left-0 sm:left-2 md:left-4 bottom-0 translate-y-1/2 z-20">

{/* avatar + mobile name wrapper */}
...
>
  {creator.name}
      ...
      {/* BELOW HERO — category + bio immediately under the “divider” (no empty rectangle) */}
      <section
        className="
          pt-2
          pl-0
      ...
      >
        ...
        {/* SHORT BIO (no ellipses needed; keep your data short in creators.ts) */}
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-semibold text-white">Popular requests</h2>
      ...
      {/* Scarcity */}
      <div className="text-sm text-purple-400">Limited availability this week.</div>
