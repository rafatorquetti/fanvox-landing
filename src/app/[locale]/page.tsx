...
export default async function Page({
  ...
  return (
    <main className="relative z-10">
      ...
      {/* HERO */}
      <section className="px-6 pt-32 pb-40">
        <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            {[
              ...
              <div key={i} className="relative group text-left min-h-[260px] flex items-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <span
                    className="
                      text-[240px] font-black
                      bg-gradient-to-b from-white via-purple-200 to-indigo-400
...
<section className="px-6 py-28">
  <div className="mx-auto w-full max-w-6xl text-center">
    ...
    <div className="flex items-center justify-between w-full opacity-70">
      ...
      {/* FOR CREATORS */}
<section className="px-6 pt-32 pb-40">
  <div className="mx-auto w-full max-w-6xl rounded-3xl border border-white/5 bg-gradient-to-br from-indigo-950 via-black to-purple-950 p-16">
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        {[
          ["$2,400", "Avg. monthly creator income"],
